...
As you can see, as number of nodes increases, the angle between $\widetilde{\textbf{V}}$ and $\textbf{V}$ is smaller.
...
<img src="{{ page.images_dir }}network-demo-gt.png" width="350px">
